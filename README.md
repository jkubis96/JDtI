...
```
df, fig3 = jseq_object.cell_regression(
        cell_x="phloem_4",
        cell_y="phloem_3",
        set_x="set1",
        set_y="set2",
...
**3.15.1 Distance from centroide - violin plot**
```
fig3_1 = jseq_object.cell_dispersion(
        cells_names=["phloem_4", "phloem_3"], 
        cells_sets=None, 
        image_width=7, 
        image_high=10
    )
...
fig3_1.savefig('dispersion.jpeg', dpi=300, bbox_inches='tight')
```
...
**3.15.2 Mean / median number of genes per cluster - bar plot**

```
fig3_2 = jseq_object.mm_cell_genes(
        cells_names=["phloem_4", "phloem_3"], 
        cells_sets=None,
...
fig3_2.savefig('mean_median_genes.jpeg', dpi=300, bbox_inches='tight')
```
...
```
fig3_3 = jseq_object.cell_genes_distribution(
        cells_names=["phloem_4", "phloem_3"], 
        cells_sets=None, 
        image_width=10, 
        image_high=7
...
fig3_3.savefig('genes_distribution.jpeg', dpi=300, bbox_inches='tight')
```
